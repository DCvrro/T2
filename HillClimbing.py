...
def Hill_Climbing_alguna_mejora(sol_inicial, costo_inicial):
    neighbor_actual = sol_inicial.copy()
    ...
    while True:
        ...
        if len(neighbor_visitados) == 10000:
            break
